...
func validateClaims(_ payload:[String: Any], audience:String?, issuer:String?) -> InvalidToken? {
...
func validateAudience(_ payload:[String: Any], audience:String?) -> InvalidToken? {
...
func validateIssuer(_ payload:[String: Any], issuer:String?) -> InvalidToken? {
...
func validateDate(_ payload:[String: Any], key:String, comparison:ComparisonResult, failure:InvalidToken, decodeError:String) -> InvalidToken? {
